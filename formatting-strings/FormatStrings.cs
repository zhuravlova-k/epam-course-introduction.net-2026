...
public static class FormatStrings
{
    ...
    {
        return string.Format(NumberFormatInfo.InvariantInfo, "{2} {3} {1} {4} {0}", str1, number1, str2, number2, number3);
    }
    ...
    {
        return string.Format(NumberFormatInfo.InvariantInfo, "| {3,-8} | {0,-12:F0} | {2,12:N2} | {5,15} | {4,11} | {1,-20:C4} |", number1, number2, number3, str1, str2, str3);
    }
}
